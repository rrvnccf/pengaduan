												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="edit_data.php" method="POST">
															<input type="hidden" name="id_tanggapan" class="form_control" value="<?php echo $data['id_tanggapan'] ?>">
															<p>Apakah yakin ingin menghapus tanggapan <br> <?php echo $data['judul_laporan'] ?> </p>
														</div>
