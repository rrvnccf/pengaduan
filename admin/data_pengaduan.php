						...
						<tbody>
							...
							while ($data = mysqli_fetch_array($query)) { ?>
								...
								<tr>
									...
									<td><img src="../aset/img<?php echo $data['foto'] ?>" width="100"></td>
									<td>
										<?php 
														...
														<div class="modal-body">
															<form action="" method="POST">
																...
																<div class="row mb-3">
																	...
																	<div class="col-md-8">
																		<img src="../aset/img<?php echo $data['foto'] ?>" width="100">
																	</div>
																</div>
																<div class="row mb-3">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="edit_data.php" method="POST">
															<input type="hidden" name="id_pengaduan" class="form_control" value="<?php echo $data['id_pengaduan'] ?>">
															<p>Apakah yakin ingin menghapus data <br> <?php echo $data['judul_laporan'] ?> </p>
														</div>
														<div class="modal-footer">
