								...
								<div class="modal-body">
									<form action="" method="POST">
										<div class="row mb-3">
											...
											<div class="col-md-8">
												<input type="text" name="nama_petugas" class="form_control" placeholder="Masukan Nama Lengkap" required>
											</div>
										</div>
										<div class="row mb-3">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="edit_data.php" method="POST">
															...
															<p>Apakah yakin ingin menghapus data <br> <?php echo $data['nama_petugas'] ?> </p>
														</div>
														<div class="modal-footer">
