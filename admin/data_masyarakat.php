								...
								<div class="modal-body">
									<form action="" method="POST">
										<div class="row mb-3">
											...
											<div class="col-md-8">
												<input type="number" name="nik" class="form_control" placeholder="Masukan NIK" required>
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-md-4">Nama Lengkap</label>
											<div class="col-md-8">
												<input type="text" name="nama" class="form_control" placeholder="Masukan Nama Lengkap" required>
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-md-4">Username</label>
											<div class="col-md-8">
												<input type="text" name="username" class="form_control" placeholder="Masukan Username" required>
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-md-4">Password</label>
											<div class="col-md-8">
												<input type="password" name="password" class="form_control" placeholder="Masukan Password" required>
											</div>
										</div>
										<div class="row mb-3">
											<label class="col-md-4">Telp</label>
											<div class="col-md-8">
												<input type="number" name="telp" class="form_control" placeholder="Masukan No. Telp" required>
											</div>
										</div>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="edit_data.php" method="POST">
															...
															<p>Apakah yakin ingin menghapus data <br> <?php echo $data['nama'] ?> </p>
														</div>
														<div class="modal-footer">
